...
Export preview, approval, verification, and artifact handoff code is retained experimental compatibility infrastructure. It does not define the active product contract; see [ADR-012](../docs/adr/ADR-012-product-trial-foundation-and-export-deferral.md).
