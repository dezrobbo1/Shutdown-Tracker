...
This record is retained as technical history. Its candidate/adoption pipeline is deferred; its no-independent-scheduler, immutable-source, and no-silent-master-write principles remain active through ADR-012.
