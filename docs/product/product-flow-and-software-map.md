...
The Master Console is the Tier 1 project-control application. Tier 1 has unrestricted operational visibility and update authority within the project, including execution actions on any task, subject to immutable Project-source and audit rules.
