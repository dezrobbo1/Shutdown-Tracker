...
| Critical reporting | Designed, not built | `infra/migrations/V006__critical_watchlists_reporting.sql` is a verified schema foundation, including source, policy, period, report, and supersession records. No Critical service, API client, or application surface exists. |
