...
- Tier 2/Tier 3 users must not be asked to resolve complex re-import or export conflicts on mobile.
...
- Tier 1 cannot approve an export candidate based on local-only progress.
