  ...
  return (
    <main className="entry-screen">
      <section className="entry-panel" aria-labelledby="login-title">
        ...
        <p className="entry-lead">Whole-project operational control, schedule handoff review, and shutdown oversight.</p>
...
function ProjectHistory() { return <><PanelHeading title="Project History" detail="Lifecycle and import/export milestones." /><ol className="activity-list"><li>24 Aug 05:52 · Accepted immutable Project snapshot v4.</li><li>23 Aug 16:10 · Project activated for operational review.</li><li>22 Aug 09:30 · Project created as Draft.</li></ol></>; }
